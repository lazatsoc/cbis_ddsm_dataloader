...
class CBISDDSMClassificationDataset(CBISDDSMGenericDataset):
    def __init__(self, dataframe, download_path, label_field, label_list, masks=False, transform=None, image_transform=None):
        super().__init__(dataframe, download_path, masks=masks, transform=transform, image_tranform=image_transform)
